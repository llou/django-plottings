...
class BasePlotView(View):
    ...
    def get_disposition(self):
        """
        Override this method if you want to dynamically set the content
    ...
    def get_filename(self):
        """
        Override this method if you want to dynamically set the name of
    ...
    def get_mimetype(self):
        """
        Override this method if you want to dynamically set the mimetype of
        the generated file.
        """
    ...
    def get_encoding(self):
        """
        Override this method if you want to dynamically set the encoding of
        the generated file.
        """
    ...
    def get(self, request, *args, **kwargs):
        ...
        response = self.http_response_class(buffer, content_type=self.get_mimetype())
    ...
    def head(self, request, *args, **kwargs):
        ...
        response = self.http_response_class(b"", content_type=self.get_mimetype())
        for key, value in headers.items():
            response.headers[key] = value
        return response
